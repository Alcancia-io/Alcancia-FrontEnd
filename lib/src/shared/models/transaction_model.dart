  ...
  factory Transaction.fromJson(Map<String, dynamic> json) {
    ...
    return Transaction(
      ...
      sourceAsset: CurrencyAsset.values
              .firstWhereOrNull((e) => e.actualAsset.toLowerCase() == sourceAsset.toString().toLowerCase())
              ?.shownAsset ??
          sourceAsset,
      targetAsset: CurrencyAsset.values
              .firstWhereOrNull((e) => e.actualAsset.toLowerCase() == targetAsset.toString().toLowerCase())
              ?.shownAsset ??
          targetAsset,
      amount: double.parse(json["amount"].toString()),
      type: TransactionType.values
          .firstWhere((e) => e.name.toUpperCase() == json["type"], orElse: () => TransactionType.unknown),
      status: TransactionStatus.values
          .firstWhere((e) => e.name.toUpperCase() == json["status"], orElse: () => TransactionStatus.unknown),
