...
final selectedGenderProvider =
    StateProvider.autoDispose<Gender?>(
        (ref) => null);
          ...
          child: ListView(
            ...
            children: [
              ...
              LabeledTextFormField(
                  controller: nameController, labelText: "Nombre(s)"),
              const SizedBox(
                height: 15,
              ),
              LabeledTextFormField(
                  controller: lastNameController, labelText: "Apellido(s)"),
              const SizedBox(
                height: 15,
              ),
              Column(
              ...
              //   height: 15,
              // ),
              //DateSelector(selectedDayProvider: selectedDayProvider, selectedMonthProvider: selectedMonthProvider, selectedYearProvider: selectedYearProvider, minYear: minYear, maxYear: maxYear),
              const SizedBox(
                height: 15,
              ),
